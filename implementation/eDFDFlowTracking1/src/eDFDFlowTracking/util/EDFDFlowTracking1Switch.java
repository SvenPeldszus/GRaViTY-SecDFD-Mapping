 ...
 * @generated
 */
public class EDFDFlowTracking1Switch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public EDFDFlowTracking1Switch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EDFDFlowTracking1Package.ELEMENT: {
			...
			case EDFDFlowTracking1Package.NAMED_ENTITY: {
