...
public class EmailDisclaimerClosure implements Closure { 
    final String msgBodyWithDisclaimer; 

    public EmailDisclaimerClosure(String msgBody) {
